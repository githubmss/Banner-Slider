...
{
    private $systemStore;//@codingStandardsIgnoreStart
        ...
        if ($this->getRequest()->getParam('id')) {
            $fieldset->addField(
                ...
                [
                    ...
                    'index'    => 'image',
                    'renderer' => '\Magentomobileshop\Bannersliderapp
                    \Block\Adminhtml\Bannersliderapp\Grid\Renderer\LogoImage',
            ...
            var d = document.getElementById(\"mssslider_thumbnail\");d.className += \" required-entry\";</script>");
        }
