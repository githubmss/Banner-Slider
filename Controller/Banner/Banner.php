...
class Banner extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $cacheObj = $this->manager->get('Magento\Framework\App\Cache');
        $cacheKey = "mss_bannerslider_store_".$this->storeId;
        $cacheTag = "mss";
        ...
        try {
            ...
            ->create('Magentomobileshop\Bannersliderapp\Model\ResourceModel\Grid\Collection')
            ...
            foreach ($connection as $key => $value) {
                ...
                $array[$k]['image_url']         = $this->storeManager
                ->getStore()
                ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . $value['thumbnail'];
